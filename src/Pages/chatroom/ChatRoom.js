...
import CurrentUserText from '../Components/chatroom/CurrentUserText'
import OtherUserText from '../Components/chatroom/OtherUserText'
import ChatNotification from '../Components/chatroom/ChatNotification'
			...
			<Container style = {styles.chatRoomContainer}>
				...
				<Container style ={styles.header}>
					...
					<Row style={styles.youAppearAsText}>
						You appear as 
						<h5 style={styles.usernameText}> {currentUsername}</h5>
